*Note:* This is under active development and is in no way ready for people to play with.
...
Compile [ReasonML](https://reasonml.github.io/) code in the `src` directory.

### `yarn watch`

Compile [ReasonML](https://reasonml.github.io/) code and watch for changes in the `src` directory.
